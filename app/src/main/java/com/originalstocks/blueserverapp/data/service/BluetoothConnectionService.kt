package com.originalstocks.blueserverapp.data.service
...
class BluetoothConnectionService(var mContext: Context, var dataCommInterface: DataCommInterface) {
        ...
        override fun run() {
            ...
            while (true) {
                ...
                try {
                    ...
                    dataCommInterface.dataFetched(incomingMessage)
                } catch (e: IOException) {
    ...
    companion object {
        ...
        private const val appName = "BlueServer"
